...
legend.onAdd = function (map) {
    ...
    var div = L.DomUtil.create('div', 'info legend');
    	...
    	div.innerHTML += 
    		...
    		'<b>Get the Data</b><br />' +
    		'<span><a href=\"ssoreports.csv\">Download SSO Reports (CSV)</a><br />' +
...
function drawTimeControlLegend(filterMin, filterMax) {
	...
	maxDateString = maxDateMonth + "/" + maxDateDay + "/" + maxDateYear;
	rangeString = "<b>" + filterMinMonth + "/" + filterMinDay + "/" + filterMinYear + "</b> through <b>" + filterMaxMonth + "/" + filterMaxDay + "/" + filterMaxYear + "</b>";
...
// add in l.geosearch for map searching; but not for ie9
